  ...
  render() {
    const plans = [
      ...
      },
      {
        title: 'Biznes PRO',
        speed: '100 Мбит/с',
        description: 'Крупный бизнес с большой командой и ресурсоемкими сервисами',
        imageUrl: Icon4,
      },
    ];
    ...
    return (
      <div className="pricing-section">
        <h2>Выберите интернет для вашего бизнеса</h2>
            ...
            {plans.map((plan, index) => (
              <div className="card" key={index}>
                <div className="card-header">
                  ...
                  <h1 className='speed'>{plan.speed}</h1>
                </div>
        ...
        <p className="pricing-description">
          В современном мире, где каждая сфера бизнеса тесно связана с онлайн-миром, надёжное подключение к Интернету становится неотъемлемой составляющей успешной деятельности. Вавилон-T
        </p>
      </div>
    );
  }
